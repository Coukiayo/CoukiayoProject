...
public class FtpUtils {
    ...
    private static  final  String FTPIP=PropertiesUtils.readPropertiesByKey("ftp.server.ip");
    private static  final  String FTPUSER=PropertiesUtils.readPropertiesByKey("ftp.server.user");
    private static  final  String FTPPASSWORD=PropertiesUtils.readPropertiesByKey("ftp.server.password");
